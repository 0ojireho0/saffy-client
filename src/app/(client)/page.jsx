  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, ease: "easeOut" }}>
        ...
        {/* Our Founder */}
        <section className="w-full bg-linear-to-b from-[#215348] to-[#092723] pt-[90.5px] xl:pb-[120.5px] px-4 lg:px-17.5 2xl:px-95.25">
          <div className="mx-auto w-full max-w-350">
            <div className="flex flex-col-reverse xl:flex-row xl:justify-between xl:gap-20 gap-10">
              {/* TEXT */}
              <motion.div
                variants={fadeUp}
                initial="hidden"
                ...
                className="py-15 sm:py-20 xl:py-[107.5px]"
              >
                <div className="xl:w-145 w-full">
                  <h1 className="text-[#E4E9A7] helvetica-bold text-[28px] sm:text-[32px]">
                    OUR FOUNDER
                  </h1>

                  <p className="mt-6 sailec-regular text-[16px] sm:text-[18px] xl:text-[20px] text-white text-justify">
                    From the belief of Sister Julian Mullie, ICM, a Belgian missionary nun, that one can "Fight Hunger
                    Through Work", SAFFY or Social Action for Filipino Youth saw the light of day in 1966. This
                    organization created alternative sources of livelihood for the unemployed and out-of-school youths
                    living in the marginalized areas of Manila.
                  </p>

                  <p className="mt-6 sailec-regular text-[16px] sm:text-[18px] xl:text-[20px] text-white text-justify">
                    The organization was later incorporated in 1970 as Social Action Foundation for Rural and Urban
                    Development, Inc. or SAFRUDI, a non-stock, non-profit social development entity imbued with Christian
                    values
                  </p>
                </div>
              ...
              <motion.div
                ...
                whileInView="show"
                viewport={{ once: true, amount: 0.3 }}
                className="xl:w-125 w-full flex justify-center xl:justify-end"
              >
                <div className="relative w-full max-w-105 sm:max-w-120 aspect-500/650 xl:max-w-none xl:w-125 xl:h-162.5 xl:aspect-auto">
                  <Image
                    src={founder}
                    alt="founder"
                    fill
                    className="object-cover rounded-xl"
                    sizes="(max-width: 640px) 90vw, (max-width: 1280px) 480px, 500px"
                  />
                </div>
              </motion.div>
            </div>
